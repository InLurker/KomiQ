package com.inlurker.komiq.model.data.mangadexapi

import com.inlurker.komiq.model.data.repository.ComicRepository.getChapterPages
...
fun main() {
    val chapterId = "a1bd9359-c160-4fb5-acfe-3f0423441841"
    runBlocking {
        println(getChapterPages(chapterId))
    }
}